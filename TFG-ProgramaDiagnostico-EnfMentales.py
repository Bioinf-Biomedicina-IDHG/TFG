...
def mostrar_formulario():
    ...
    def mostrar_ventana_esquizofrenia():
        ...
        ventana_esquizofrenia.title("Test Diagnóstico del Trastorno Esquizoide según el DSM-V")    
...
# GENES ESQUIZOFRENIA
    ...
    def mostrar_ventana_genes_e():
        ...
        ventana_genes_e.title("Marcadores genéticos para el Trastorno Esquizoide")    
